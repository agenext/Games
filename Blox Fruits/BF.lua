	...
	elseif Sea2 then
	  IslandsPos = {
	    ["The Cafe"] = Vector3.new(-382, 73, 290),
	    ["Frist Spot"] = Vector3.new(-11, 29, 2771),
	    ["Dark Area"] = Vector3.new(3494, 13, -3259),
		...
		while task.wait() do
			...
			if Humanoid and Humanoid.Health > 0 then
				if _G.ChangeDashDistance then
					Char:SetAttribute("DashLenght", _G.SelectDashDistance)
					Char:SetAttribute("DashLenghtAir", _G.SelectDashDistance)
				else
